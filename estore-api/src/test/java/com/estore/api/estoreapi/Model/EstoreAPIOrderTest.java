...
class EstoreApiOrderTests {
	...
	public void testCtor() {
		...
		// Invoke
		Order order = new Order(expected_id, expected_email, expected_address, expected_payment, expected_price, expected_products);
	...
	public void testEmail() {
		...
		Order order = new Order(id, email, address, payment, price, products);
	...
	public void testToString() {
        ...
        products[1] = Map.of("second ingredient", 12.0);
		Order order = new Order(id, email, address, payment, price, products);
        String expected_string = String.format(Order.getSTRING_FORMAT(), id, email, address, payment, price, products);

...
public class UserController {
     ...
     *             {@link User users}
     * 
     * @return ResponseEntity with array of {@link User hero} objects (may be
     *         empty) and
     *         HTTP status of OK<br>
     *         ResponseEntity with HTTP status of INTERNAL_SERVER_ERROR otherwise
     *         <p>
     ...
     * 
     * @param User user The {@link User user} to update
     * 
    ...
    public ResponseEntity<User> updateUser(@RequestBody User user) {
        ...
        try {
            User userCheck = userDao.updateUser(user);
            if (userCheck != null) {
                return new ResponseEntity<User>(userCheck, HttpStatus.OK);
            }
